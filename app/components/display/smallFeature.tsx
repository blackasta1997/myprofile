    ...
    <section ref={sectionRef} className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className={`grid grid-flow-col auto-col-max transition-all duration-700 transform ${
          ...
          <div className={`grid grid-flow-col auto-col-max transition-all duration-700 transform delay-150 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
          ...
          <div className={`grid grid-flow-col auto-col-max transition-all duration-700 transform delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            <div className="w-16 h-16 flex justify-center">

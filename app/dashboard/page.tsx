            ...
            <nav className="space-y-2 bg-white rounded-lg shadow-sm p-4 sticky top-24 h-fit">
              {navigationItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all text-left ${activeTab === item.id
          ...
          <div className="flex-1">
                ...
                <div className="mb-8 pb-8 border-b border-gray-200">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    <div className="relative">
                      <div className="w-24 h-24 rounded-full overflow-hidden shadow-lg flex items-center justify-center">
                      ...
                      {appointments.map((appointment) => (
                        <div key={appointment.id} className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-lg border border-indigo-200 p-6 hover:shadow-lg transition">
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <span
                              className={`px-3 py-1 rounded-full text-xs font-semibold ${appointment.status === 'scheduled'
            ...
            {activeTab === 'profile' && (
              <div className="bg-white rounded-lg shadow-md p-8">
                ...
                {message && (
                  <div
                    className={`flex items-center gap-2 p-4 rounded-lg text-sm mb-6 ${message.type === 'success'
